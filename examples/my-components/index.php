...
<p>Подробную информацию по созданию компонентов вы можете найти в <a href="http://www.bitrixsoft.ru/help/source/main/help/ru/developer/general/component20/01.components.php.html">документации для разработчика</a>.</p><?php
